...
#include <locale>  //For the wstring_convert
#include <codecvt>
...
Mesh::Mesh(const wchar_t* full_path):Resource(full_path)
{
	...
	std::string inputfile = std::wstring_convert<std::codecvt_utf8<wchar_t>>().to_bytes(full_path); // TinyObjLoader needs ascii code
